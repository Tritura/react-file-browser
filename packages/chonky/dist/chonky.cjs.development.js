...
var getIconTrie = function getIconTrie() {
  ...
  // Brands file types
  [exports.ChonkyIconName.adobe, ['psd']],
  // Other program file types
 ...
 * @license MIT
 */
var ChonkyBusinessLogicInner = /*#__PURE__*/React__default.memo( /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  var _props$files;
  // ==== Update Redux state
...
var ChonkyBusinessLogic = /*#__PURE__*/React__default.memo(ChonkyBusinessLogicInner);
...
var DnDFileListDragLayer = function DnDFileListDragLayer() {
  ...
  }, React__default.createElement("b", null, item.payload.draggedFile.name), selectionSize > 1 && React__default.createElement(React__default.Fragment, null, ' and ', React__default.createElement("strong", null, selectionSize - 1, " other file", selectionSize - 1 !== 1 ? 's' : '')))));
};
 ...
 * @license MIT
 */
var HotkeyListener = /*#__PURE__*/React__default.memo(function (props) {
...
var ChonkyPresentationLayer = function ChonkyPresentationLayer(_ref) {
  ...
  var hotkeyListenerComponents = React.useMemo(function () {
    return fileActionIds.map(function (actionId) {
      return React__default.createElement(HotkeyListener, {
  ...
  }, !dndDisabled && dndContextAvailable && React__default.createElement(DnDFileListDragLayer, null), hotkeyListenerComponents, children ? children : null));
};
...
//     });
// }
var FileBrowser = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  var _ref;
  ...
  var theme = React.useMemo(function () {
    var muiTheme = styles.createMuiTheme({
      palette: {
  ...
  var chonkyComps = React__default.createElement(React__default.Fragment, null, React__default.createElement(ChonkyBusinessLogic, Object.assign({
    ref: ref
  }, props)), React__default.createElement(ChonkyPresentationLayer, null, children));
  return React__default.createElement(reactIntl.IntlProvider, Object.assign({
    locale: "en",
    defaultLocale: "en"
  }, i18n), React__default.createElement(ChonkyFormattersContext.Provider, {
    value: formatters
  }, React__default.createElement(reactRedux.Provider, {
    store: store
  }, React__default.createElement(reactJss.ThemeProvider, {
    theme: theme
  }, React__default.createElement(styles.ThemeProvider, {
    theme: theme
  }, React__default.createElement(ChonkyIconContext.Provider, {
    value: (_ref = iconComponent != null ? iconComponent : defaultConfig.iconComponent) != null ? _ref : ChonkyIconPlaceholder
  }, disableDragAndDrop || disableDragAndDropProvider ? chonkyComps : React__default.createElement(reactDnd.DndProvider, {
...
var TextPlaceholder = /*#__PURE__*/React__default.memo(function (props) {
...
var useModifierIconComponents = function useModifierIconComponents(file) {
  ...
  var modifierIconComponents = React.useMemo(function () {
    return modifierIcons.map(function (icon, index) {
      return React__default.createElement(ChonkyIcon, {
...
var useFileNameComponent = function useFileNameComponent(file) {
  return React.useMemo(function () {
    if (!file) return React__default.createElement(TextPlaceholder, {
      minLength: 15,
      maxLength: 20
    });
    var name;
    ...
    return React__default.createElement(React__default.Fragment, null, name, extension && React__default.createElement("span", {
 ...
 * @license MIT
 */
var ToolbarButton = /*#__PURE__*/React__default.memo(function (props) {
  var _c;
  ...
  var ChonkyIcon = React.useContext(ChonkyIconContext);
  var iconComponent = icon || iconOnly ? React__default.createElement("div", {
    className: iconOnly ? '' : classes.iconWithText
  }, React__default.createElement(ChonkyIcon, {
  ...
  }, iconComponent, text && !iconOnly && React__default.createElement("span", null, text), dropdown && React__default.createElement("div", {
    className: classes.iconDropdown
  }, React__default.createElement(ChonkyIcon, {
    icon: icon ? icon : exports.ChonkyIconName.dropdown,
    fixedWidth: true
  })));
});
...
var SmartToolbarButton = /*#__PURE__*/React__default.memo(function (props) {
  var fileActionId = props.fileActionId;
  var action = useParamSelector(selectFileActionData, fileActionId);
 ...
 * @license MIT
 */
var FolderChainButton = /*#__PURE__*/React__default.memo(function (_ref) {
  var _c;
  ...
  return React__default.createElement("div", {
    ...
    ref: file ? drop : null
  }, file && dndIconName && React__default.createElement("div", {
 ...
 * @license MIT
 */
var FileNavbar = /*#__PURE__*/React__default.memo(function () {
  ...
  var folderChainComponents = React.useMemo(function () {
    ...
    for (var i = 0; i < folderChainItems.length; ++i) {
      ...
      var component = React__default.createElement(FolderChainButton, {
        key: key,
        first: i === 0,
  ...
  }, React__default.createElement(SmartToolbarButton, {
 ...
 * @license MIT
 */
var ToolbarDropdownButton = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  var _c;
  var text = props.text,
    active = props.active,
    icon = props.icon,
  ...
  return React__default.createElement(MenuItem, {
    ...
    onClick: onClick,
    disabled: disabled
  }, icon && React__default.createElement(ListItemIcon, {
...
var SmartToolbarDropdownButton = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  var fileActionId = props.fileActionId,
  ...
  if (!button) return null;
  if (action.customVisibility !== undefined && action.customVisibility() === exports.CustomVisibilityState.Hidden) return null;
  return React__default.createElement(ToolbarDropdownButton, {
    ref: ref,
    text: buttonName,
    icon: icon,
    onClick: handleClick,
 ...
 * @license MIT
 */
var ToolbarDropdown = /*#__PURE__*/React__default.memo(function (props) {
  var name = props.name,
  ...
  var menuItemComponents = React.useMemo(function () {
    return fileActionIds.map(function (id) {
      return React__default.createElement(SmartToolbarDropdownButton, {
        key: "menu-item-" + id,
        fileActionId: id,
 ...
 * @license MIT
 */
var ToolbarInfo = /*#__PURE__*/React__default.memo(function () {
  ...
  return React__default.createElement("div", {
    ...
    variant: "body1"
  }, fileCountString, (selectedString || hiddenString) && React__default.createElement("span", {
    className: classes.extraInfoSpan
  }, "(", React__default.createElement("span", {
    className: classes.selectionSizeText
  }, selectedString), selectedString && hiddenString && ', ', React__default.createElement("span", {
 ...
 * @license MIT
 */
var ToolbarSearch = /*#__PURE__*/React__default.memo(function () {
  var intl = reactIntl.useIntl();
...
var FileToolbar = /*#__PURE__*/React__default.memo(function () {
  ...
  var toolbarItemComponents = React.useMemo(function () {
    ...
    for (var i = 0; i < toolbarItems.length; ++i) {
      ...
      var component = typeof item === 'string' ? React__default.createElement(SmartToolbarButton, {
        key: key,
        fileActionId: item
      }) : React__default.createElement(ToolbarDropdown, {
        key: key,
        name: item.name,
  ...
  }, React__default.createElement(ToolbarSearch, null), React__default.createElement(ToolbarInfo, null)), React__default.createElement("div", {
...
var ClickableWrapper = function ClickableWrapper(props) {
  ...
  return React__default.createElement(WrapperTag, Object.assign({}, mergedProps), children);
};
 ...
 * @license MIT
 */
var FileEntryName = /*#__PURE__*/React__default.memo(function (_ref) {
  var file = _ref.file,
  ...
  }, modifierIconComponents.length > 0 && React__default.createElement("span", {
...
var CompactEntry = /*#__PURE__*/React__default.memo(
// @ts-ignore
function (_ref) {
  var file = _ref.file,
  ...
  return React__default.createElement("div", Object.assign({
  ...
  }, fileEntryHtmlProps), React__default.createElement("div", {
    ...
    title: file ? file.name : undefined
  }, React__default.createElement(FileEntryName, {
    file: file
  })), React__default.createElement("div", {
    className: classes.listFileEntryProperties
  }, React__default.createElement("div", {
    className: classes.listFileEntryProperty
  }, file ? fileModDateString != null ? fileModDateString : React__default.createElement("span", null, "\u2014") : React__default.createElement(TextPlaceholder, {
    minLength: 5,
    maxLength: 15
  })), React__default.createElement("div", {
    className: classes.listFileEntryProperty
  }, file ? fileSizeString != null ? fileSizeString : React__default.createElement("span", null, "\u2014") : React__default.createElement(TextPlaceholder, {
    minLength: 10,
    maxLength: 20
  })))), React__default.createElement("div", {
...
var DnDFileEntry = /*#__PURE__*/React__default.memo(function (_ref) {
  var file = _ref.file,
 ...
 * @license MIT
 */
var FileThumbnail = /*#__PURE__*/React__default.memo(function (props) {
 ...
 * @license MIT
 */
var GridEntryDndIndicator = /*#__PURE__*/React__default.memo(function (props) {
  var _c;
  var externalClassName = props.className,
 ...
 * @license MIT
 */
var GridEntryPreviewFolder = /*#__PURE__*/React__default.memo(function (props) {
  var _c;
  var externalClassName = props.className,
  ...
  }, React__default.createElement(GridEntryDndIndicator, {
    className: fileClasses.dndIndicator,
    dndState: dndState
  }), React__default.createElement("div", {
    className: c([fileClasses.fileIcon, folderClasses.fileIcon])
  }, entryState.childrenCount), React__default.createElement("div", {
    className: commonClasses.selectionIndicator
  }), React__default.createElement(FileThumbnail, {
...
var GridEntryPreviewFile = /*#__PURE__*/React__default.memo(function (props) {
  var _c2;
  var externalClassName = props.className,
    entryState = props.entryState,
    dndState = props.dndState;
...
var GridEntry = /*#__PURE__*/React__default.memo(function (_ref) {
  var _c;
  var file = _ref.file,
    selected = _ref.selected,
    focused = _ref.focused,
  ...
  }, fileEntryHtmlProps), isDirectory ? React__default.createElement(GridEntryPreviewFolder, {
    className: classes.gridFileEntryPreview,
    entryState: entryState,
    dndState: dndState
  }) : React__default.createElement(GridEntryPreviewFile, {
    className: classes.gridFileEntryPreview,
    entryState: entryState,
    dndState: dndState
  }), React__default.createElement("div", {
...
var ListEntry = /*#__PURE__*/React__default.memo(function (_ref) {
  var file = _ref.file,
    selected = _ref.selected,
    focused = _ref.focused,
    dndState = _ref.dndState;
...
var SmartFileEntry = /*#__PURE__*/React__default.memo(function (_ref) {
  ...
  return dndDisabled ? React__default.createElement(ClickableWrapper, Object.assign({}, clickableWrapperProps), React__default.createElement(EntryComponent, Object.assign({}, fileEntryProps, {
    dndState: disabledDndState
  }))) : React__default.createElement(DnDFileEntry, {
    file: file
  }, function (dndState) {
    return React__default.createElement(ClickableWrapper, Object.assign({}, clickableWrapperProps), React__default.createElement(EntryComponent, Object.assign({}, fileEntryProps, {
      dndState: dndState
    })));
  });
});
...
var GridContainer = /*#__PURE__*/React__default.memo(function (props) {
  var width = props.width,
    height = props.height;
  ...
  var cellRenderer = React.useCallback(function (data) {
    ...
    }, React__default.createElement(SmartFileEntry, {
  ...
  var gridComponent = React.useMemo(function () {
    return React__default.createElement(reactWindow.VariableSizeGrid, {
      ref: gridRef,
 ...
 * @license MIT
 */
var ListContainer = /*#__PURE__*/React__default.memo(function (props) {
  var width = props.width,
    height = props.height;
  var viewConfig = reactRedux.useSelector(selectFileViewConfig);
  ...
  var listComponent = React.useMemo(function () {
    ...
    return React__default.createElement(reactWindow.FixedSizeList, {
      ref: listRef,
...
var FileList = /*#__PURE__*/React__default.memo(function (props) {
  var displayFileIds = reactRedux.useSelector(selectors.getDisplayFileIds);
  var viewConfig = reactRedux.useSelector(selectFileViewConfig);
  ...
  var listRenderer = React.useCallback(function (_ref) {
    ...
    if (displayFileIds.length === 0) {
      return React__default.createElement(FileListEmpty, {
        width: width,
      ...
      return React__default.createElement(GridContainer, {
        width: width,
        height: height
      });
    }
  ...
  }))), React__default.createElement(AutoSizer, {
 ...
 * @license MIT
 */
var FileContextMenu = /*#__PURE__*/React__default.memo(function () {
  var dispatch = reactRedux.useDispatch();
  React.useEffect(function () {
  ...
  var browserMenuShortcutString = intl.formatMessage({
    ...
    shortcut: React__default.createElement("strong", null, "Alt + Right Click")
  });
  ...
  var contextMenuItemComponents = React.useMemo(function () {
    ...
    var _loop = function _loop() {
      ...
      if (typeof item === 'string') {
        components.push(React__default.createElement(SmartToolbarDropdownButton, {
        ...
        item.fileActionIds.map(function (id) {
          return components.push(React__default.createElement(SmartToolbarDropdownButton, {
  ...
  }, contextMenuItemComponents, React__default.createElement(ListSubheader, {
    component: "div",
